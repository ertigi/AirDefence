...
public class Shooting {
    ...
    public Shooting(GameSettings gameSettings, LevelData levelData, BulletController bulletController, MonoBehaviour monoBehaviour) {
    ...
    private void Shoot() {
        ...
        _bulletController.SpawnPlayerBullet(_turel.Barrels[_currentBarrelIndex]);
